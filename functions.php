...
function dfy_scripts() {
	...
	wp_register_style('font-awesome', get_template_directory_uri() . 'assets/css/fontawesome.min.css', [], false, 'all');
	wp_register_style('font-awesome-all', get_template_directory_uri() . 'assets/css/font-awesome/all.min.css', [], false, 'all');
